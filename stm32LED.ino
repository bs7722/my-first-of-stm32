/*安裝步驟(先別問為什麼,至少比起網路教學文章沒一個模仿/重複實驗成功的來得好)*/
...
//STM32上pin 13(PC13)接的LED預設是LOW=1,HIGH=0,LED顯示的電壓值與人類習慣性直觀不同，其原因與硬體有關，在此不多做解釋，懂的人自己想通，不懂的自己在上網查(pull-up/pull-down circuit)。
#define pinLED PC13
